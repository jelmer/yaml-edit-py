...
# A value accepted by the setters: a scalar, ``None`` (written as a YAML null),
# or an existing node wrapper whose source text is copied into the destination.
NodeValue = Union[ScalarValue, None, "Node", "Mapping", "Sequence", "Scalar"]
...
class Node:
    ...
    def __setitem__(self, key: Union[str, int], value: NodeValue) -> None: ...
    def __delitem__(self, key: Union[str, int]) -> None: ...
    def __iter__(self) -> Iterator[Union[str, Node]]: ...
...
class Entry:
    ...
    def set_value(self, value: NodeValue) -> None: ...
...
class Mapping:
    ...
    def set(self, key: str, value: NodeValue) -> None: ...
    def __setitem__(self, key: str, value: NodeValue) -> None: ...
...
class MergedMapping:
    ...
    def get(self, key: str) -> Optional[Node]: ...
    def __getitem__(self, key: str) -> Node: ...
    def get_merged(self, key: str) -> Optional[MergedMapping]: ...
    def keys(self) -> list[str]: ...
    def values(self) -> list[Node]: ...
    def items(self) -> list[tuple[str, Node]]: ...
    def __iter__(self) -> Iterator[str]: ...
...
class Sequence:
    ...
    def insert(self, index: int, value: NodeValue) -> None: ...
    def set(self, index: int, value: NodeValue) -> bool: ...
    def __setitem__(self, index: int, value: NodeValue) -> None: ...
...
class Document:
    ...
    def as_sequence(self) -> Optional[Sequence]: ...
    def as_scalar(self) -> Optional[Scalar]: ...
    def merged(self) -> Optional[MergedMapping]: ...
    def contains_key(self, key: str) -> bool: ...
    def __contains__(self, key: str) -> bool: ...
    def get(self, key: str) -> Optional[Node]: ...
    def __getitem__(self, key: str) -> Node: ...
